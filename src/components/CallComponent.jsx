  ...
  <>
    ...
    <div>
      ...
      <div className="mt-2">
        <input
          ...
          autoComplete="email"
          required
          className="block w-full rounded-md border-0 p-1.5 text-gray-200 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
        />
      </div>
    </div>
    ...
    <div>
      <button
        type="submit"
        disabled={!isOnline}
        className="flex w-full justify-center rounded-md bg-orange-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
      >
    ...
    {callWaiting && (
      <div className="md:top-5 bottom-5 h-16 w-72 flex-col text-white flex items-center justify-center rounded-lg bg-orange-600 fixed z-50 left-1/2 transform -translate-x-1/2 right-1/2">
    ...
    {ringingWithCall && (
      ...
      <div className="form w-fit  h-fit p-6  rounded-xl shadow-lg flex flex-col gap-4 justify-center items-center text-white">
...
const CallingPopUp = ({UserEmail, callEndFunction , secondPersonAvatarUrl}) =>{
  return (<div className="form z-50 flex-col h-screen gap-8 w-screen text-white flex  items-center justify-center fixed  ">
